...
// La clase Paleta_EM contiene los colores del parchís y los sirve a los pintores
public class Paleta_EM
{
    ...
    public Color tomaColor(int n)  //HEMOS QUITADO EL SYNCHRONIZE
    {
    ...
    public void dejaColor(int n)  //HEMOS QUITADO EL SYNCHRONIZE
    {
        int i=n%4; //para evitar errores de índice, si n>3 se sustituye por su resto
        ocupado[i]=false;
        notifyAll();
