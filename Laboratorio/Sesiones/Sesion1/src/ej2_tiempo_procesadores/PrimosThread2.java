...
// Clase PrimosThread2 sirve para calcular cuántos primos hay entre dos enteros

import java.util.Date;

public class PrimosThread2 extends Thread {
    
    private int id, x, y, n=0;
    private long ti;
    
    public PrimosThread2(int x, int y, int id, long ti){
